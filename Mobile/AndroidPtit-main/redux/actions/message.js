...
const actions = {
  ...
  listImage: (data) => async (dispatch) => {
    try {
      ...
      Alert.alert("Get list Image fail!");
      dispatch({
  ...
  listFile: (data) => async (dispatch) => {
    try {
      ...
      Alert.alert("Get list File fail!");
      dispatch({
  ...
  readMore: (id, skip = 0, limit = 30) => async (dispatch) => {
    try {
      ...
      Alert.alert("Read more message fail!");
      dispatch({
