        ...
        {audioInput && audioInput.length > 0 && (
          <>
            <div style={{ width: "100%", display: "flex" }}>
              ...
              <Select
                onChange={(value) => onSelect(value, "audioInput")}
                name="audioInput"
                defaultValue={defaultAudioInput || audioInput[0].deviceId}
                style={{ width: "70%" }}
              >
        ...
        {audioOutput && audioOutput.length > 0 && (
          <>
            <div style={{ width: "100%", display: "flex" }}>
              ...
              <Select
                onChange={(value) => onSelect(value, "audioOutput")}
                defaultValue={defaultAudioOutput || audioOutput[0].deviceId}
                style={{ width: "70%" }}
              >
        ...
        {videoInput && videoInput.length > 0 && (
          ...
          >
            ...
            <Select
              ...
              defaultValue={defaultVideoInput || videoInput[0].deviceId}
              style={{ width: "70%" }}
            >
