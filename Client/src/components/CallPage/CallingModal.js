...
import { emitAnswerCall, emitRejectCall } from "../../sockets/call";
...
const CallingModal = () => {
  ...
  return (
    <Modal visible={callStatus === "calling"} footer={null} closable={false}>
      <Row
        type="flex"
        align="middle"
        justify="center"
      ...
      >
        ...
        >
          ...
          <p style={{ marginTop: "15px" }}>
            <strong>{caller.userName}</strong> is calling ...
          </p>
          <div>
            <Button
              icon="phone"
